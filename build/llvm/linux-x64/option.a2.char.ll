; ModuleID = 'option$a2$char$'
source_filename = "option$a2$char$"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%.introspect = type { i8, i64, ptr, i64, i64, i64, [0 x i64] }
%"char[]" = type { ptr, i64 }
%Option = type { [2 x i8], i8 }

$"option$a2$char$.Option.unwrap" = comdat any

$"option$a2$char$.Option.unwrap_or" = comdat any

$"option$a2$char$.Option.isSome" = comdat any

$"option$a2$char$.Option.isNone" = comdat any

$"option$a2$char$.some" = comdat any

$"$ct.option$a2$char$.Option" = comdat any

@"$ct.option$a2$char$.Option" = linkonce global %.introspect { i8 9, i64 0, ptr null, i64 3, i64 0, i64 2, [0 x i64] zeroinitializer }, comdat, align 8
...
define weak i16 @"option$a2$char$.Option.unwrap"(ptr %0) #0 comdat !dbg !9 {
entry:
...
checkok:                                          ; preds = %entry
  ...
  %ptradd = getelementptr inbounds i8, ptr %3, i64 2, !dbg !27
  %4 = load i8, ptr %ptradd, align 1, !dbg !27
...
if.exit:                                          ; preds = %voiderr, %checkok
  ...
  %29 = load i16, ptr %28, align 1, !dbg !50
  ret i16 %29, !dbg !50
...
; Function Attrs: nounwind ssp uwtable
define weak i16 @"option$a2$char$.Option.unwrap_or"(ptr %0, i16 %1) #0 comdat !dbg !51 {
entry:
  %self = alloca ptr, align 8
  %_default = alloca [2 x i8], align 1
...
checkok:                                          ; preds = %entry
  ...
  store i16 %1, ptr %_default, align 1
    #dbg_declare(ptr %_default, !57, !DIExpression(), !58)
  %4 = load ptr, ptr %self, align 8, !dbg !59
  %ptradd = getelementptr inbounds i8, ptr %4, i64 2, !dbg !59
  %5 = load i8, ptr %ptradd, align 1, !dbg !59
  %6 = trunc i8 %5 to i1, !dbg !59
  br i1 %6, label %if.then, label %if.exit, !dbg !59

if.then:                                          ; preds = %checkok
  %7 = load ptr, ptr %self, align 8, !dbg !60
  %8 = call i16 @"option$a2$char$.Option.unwrap"(ptr %7), !dbg !60
  store i16 %8, ptr %result, align 1
  %9 = load i16, ptr %result, align 1
  ret i16 %9

if.exit:                                          ; preds = %checkok
  %10 = load i16, ptr %_default, align 1, !dbg !62
  ret i16 %10, !dbg !62
...
; Function Attrs: nounwind ssp uwtable
define weak zeroext i8 @"option$a2$char$.Option.isSome"(ptr %0) #0 comdat !dbg !63 {
entry:
  %self = alloca ptr, align 8
...
checkok:                                          ; preds = %entry
  ...
  %ptradd = getelementptr inbounds i8, ptr %3, i64 2, !dbg !69
  %4 = load i8, ptr %ptradd, align 1, !dbg !69
  ret i8 %4, !dbg !69
...
; Function Attrs: nounwind ssp uwtable
define weak zeroext i8 @"option$a2$char$.Option.isNone"(ptr %0) #0 comdat !dbg !70 {
entry:
  %self = alloca ptr, align 8
...
checkok:                                          ; preds = %entry
  ...
  %ptradd = getelementptr inbounds i8, ptr %3, i64 2, !dbg !74
  %4 = load i8, ptr %ptradd, align 1, !dbg !74
...
; Function Attrs: nounwind ssp uwtable
define weak i24 @"option$a2$char$.some"(i16 %0) #0 comdat !dbg !75 {
entry:
  %value = alloca [2 x i8], align 1
  %literal = alloca %Option, align 1
  ...
  call void @llvm.memcpy.p0.p0.i32(ptr align 1 %literal, ptr align 1 %value, i32 2, i1 false), !dbg !80
  %ptradd2 = getelementptr inbounds i8, ptr %literal, i64 2, !dbg !80
  store i8 1, ptr %ptradd2, align 1, !dbg !81
  call void @llvm.memcpy.p0.p0.i32(ptr align 4 %tempcoerce, ptr align 1 %literal, i32 3, i1 false)
  %1 = load i24, ptr %tempcoerce, align 4
  ret i24 %1
}
...
!9 = distinct !DISubprogram(name: "unwrap", linkageName: "option$a2$char$.Option.unwrap", scope: !8, file: !8, line: 17, type: !10, scopeLine: 17, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !23)
!10 = !DISubroutineType(types: !11)
!11 = !{!12, !17}
!12 = !DIDerivedType(tag: DW_TAG_typedef, name: "Type", scope: !8, file: !8, line: 175, baseType: !13, align: 1)
!13 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 16, align: 8, elements: !15)
...
!18 = !DICompositeType(tag: DW_TAG_structure_type, name: "Option", scope: !8, file: !8, line: 5, size: 24, align: 8, elements: !19, identifier: "option$a2$char$.Option")
!19 = !{!20, !21}
!20 = !DIDerivedType(tag: DW_TAG_member, name: "val", scope: !18, file: !8, line: 6, baseType: !12, size: 16, align: 8)
!21 = !DIDerivedType(tag: DW_TAG_member, name: "has", scope: !18, file: !8, line: 7, baseType: !22, size: 8, align: 8, offset: 16)
...
!51 = distinct !DISubprogram(name: "unwrap_or", linkageName: "option$a2$char$.Option.unwrap_or", scope: !8, file: !8, line: 25, type: !52, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !23)
...
!63 = distinct !DISubprogram(name: "isSome", linkageName: "option$a2$char$.Option.isSome", scope: !8, file: !8, line: 32, type: !64, scopeLine: 32, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !23)
...
!70 = distinct !DISubprogram(name: "isNone", linkageName: "option$a2$char$.Option.isNone", scope: !8, file: !8, line: 36, type: !64, scopeLine: 36, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !23)
...
!75 = distinct !DISubprogram(name: "some", linkageName: "option$a2$char$.some", scope: !8, file: !8, line: 10, type: !76, scopeLine: 10, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !23)
