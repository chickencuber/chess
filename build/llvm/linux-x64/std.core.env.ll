...
@.str = private unnamed_addr constant [41 x i8] c"6e348d1e712ef918eb23cb5c4ae16ca036d4de7b\00", align 1
@std.core.env.COMPILER_BUILD_HASH = weak local_unnamed_addr constant %"char[]" { ptr @.str, i64 40 }, comdat, align 8, !dbg !0
@.str.45 = private unnamed_addr constant [11 x i8] c"2025-06-05\00", align 1
@std.core.env.COMPILER_BUILD_DATE = weak local_unnamed_addr constant %"char[]" { ptr @.str.45, i64 10 }, comdat, align 8, !dbg !12
@std.core.env.OS_TYPE = weak local_unnamed_addr constant i32 9, comdat, align 4, !dbg !14
@std.core.env.ARCH_TYPE = weak local_unnamed_addr constant i32 32, comdat, align 4, !dbg !56
@std.core.env.MAX_VECTOR_SIZE = weak local_unnamed_addr constant i64 4096, comdat, align 8, !dbg !111
@std.core.env.ARCH_32_BIT = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !113
@std.core.env.ARCH_64_BIT = weak local_unnamed_addr constant i8 1, comdat, align 1, !dbg !116
@std.core.env.LIBC = weak local_unnamed_addr constant i8 1, comdat, align 1, !dbg !118
@std.core.env.NO_LIBC = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !120
@std.core.env.COMPILER_OPT_LEVEL = weak local_unnamed_addr constant i32 0, comdat, align 4, !dbg !122
@std.core.env.BIG_ENDIAN = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !130
@std.core.env.I128_NATIVE_SUPPORT = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !132
@std.core.env.F16_SUPPORT = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !134
@std.core.env.F128_SUPPORT = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !136
@std.core.env.REGISTER_SIZE = weak local_unnamed_addr constant i32 64, comdat, align 4, !dbg !138
@std.core.env.COMPILER_SAFE_MODE = weak local_unnamed_addr constant i8 1, comdat, align 1, !dbg !140
@std.core.env.DEBUG_SYMBOLS = weak local_unnamed_addr constant i8 1, comdat, align 1, !dbg !142
@std.core.env.BACKTRACE = weak local_unnamed_addr constant i8 1, comdat, align 1, !dbg !144
@std.core.env.LLVM_VERSION = weak local_unnamed_addr constant i64 20, comdat, align 8, !dbg !146
@std.core.env.BENCHMARKING = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !148
@std.core.env.TESTING = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !150
@std.core.env.MEMORY_ENV = weak local_unnamed_addr constant i32 0, comdat, align 4, !dbg !152
@std.core.env.TRACK_MEMORY = weak local_unnamed_addr constant i8 1, comdat, align 1, !dbg !160
@std.core.env.X86_64 = weak local_unnamed_addr constant i8 1, comdat, align 1, !dbg !162
@std.core.env.X86 = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !164
@std.core.env.AARCH64 = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !166
@std.core.env.NATIVE_STACKTRACE = weak local_unnamed_addr constant i8 1, comdat, align 1, !dbg !168
@std.core.env.LINUX = weak local_unnamed_addr constant i8 1, comdat, align 1, !dbg !170
@std.core.env.DARWIN = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !172
@std.core.env.WIN32 = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !174
@std.core.env.POSIX = weak local_unnamed_addr constant i8 1, comdat, align 1, !dbg !176
@std.core.env.OPENBSD = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !178
@std.core.env.FREEBSD = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !180
@std.core.env.NETBSD = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !182
@std.core.env.BSD_FAMILY = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !184
@std.core.env.WASI = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !186
@std.core.env.ANDROID = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !188
@std.core.env.WASM_NOLIBC = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !190
@std.core.env.ADDRESS_SANITIZER = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !192
@std.core.env.MEMORY_SANITIZER = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !194
@std.core.env.THREAD_SANITIZER = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !196
@std.core.env.ANY_SANITIZER = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !198
@std.core.env.LANGUAGE_DEV_VERSION = weak local_unnamed_addr constant i32 7, comdat, align 4, !dbg !200
@std.core.env.BUILTIN_EXPECT_IS_DISABLED = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !202
@std.core.env.BUILTIN_PREFETCH_IS_DISABLED = weak local_unnamed_addr constant i8 0, comdat, align 1, !dbg !204
...
!2 = !DIFile(filename: "env.c3", directory: "/usr/lib/c3c/lib/std/core")
...
!153 = distinct !DIGlobalVariable(name: "MEMORY_ENV", linkageName: "std.core.env.MEMORY_ENV", scope: !2, file: !2, line: 140, type: !154, isLocal: false, isDefinition: true, align: 4)
!154 = !DICompositeType(tag: DW_TAG_enumeration_type, name: "MemoryEnvironment", scope: !2, file: !2, line: 14, baseType: !17, size: 32, align: 32, elements: !155)
!155 = !{!156, !157, !158, !159}
!156 = !DIEnumerator(name: "NORMAL", value: 0)
!157 = !DIEnumerator(name: "SMALL", value: 1)
!158 = !DIEnumerator(name: "TINY", value: 2)
!159 = !DIEnumerator(name: "NONE", value: 3)
!160 = !DIGlobalVariableExpression(var: !161, expr: !DIExpression())
!161 = distinct !DIGlobalVariable(name: "TRACK_MEMORY", linkageName: "std.core.env.TRACK_MEMORY", scope: !2, file: !2, line: 141, type: !115, isLocal: false, isDefinition: true, align: 1)
!162 = !DIGlobalVariableExpression(var: !163, expr: !DIExpression())
!163 = distinct !DIGlobalVariable(name: "X86_64", linkageName: "std.core.env.X86_64", scope: !2, file: !2, line: 142, type: !115, isLocal: false, isDefinition: true, align: 1)
!164 = !DIGlobalVariableExpression(var: !165, expr: !DIExpression())
!165 = distinct !DIGlobalVariable(name: "X86", linkageName: "std.core.env.X86", scope: !2, file: !2, line: 143, type: !115, isLocal: false, isDefinition: true, align: 1)
!166 = !DIGlobalVariableExpression(var: !167, expr: !DIExpression())
!167 = distinct !DIGlobalVariable(name: "AARCH64", linkageName: "std.core.env.AARCH64", scope: !2, file: !2, line: 144, type: !115, isLocal: false, isDefinition: true, align: 1)
!168 = !DIGlobalVariableExpression(var: !169, expr: !DIExpression())
!169 = distinct !DIGlobalVariable(name: "NATIVE_STACKTRACE", linkageName: "std.core.env.NATIVE_STACKTRACE", scope: !2, file: !2, line: 145, type: !115, isLocal: false, isDefinition: true, align: 1)
!170 = !DIGlobalVariableExpression(var: !171, expr: !DIExpression())
!171 = distinct !DIGlobalVariable(name: "LINUX", linkageName: "std.core.env.LINUX", scope: !2, file: !2, line: 146, type: !115, isLocal: false, isDefinition: true, align: 1)
!172 = !DIGlobalVariableExpression(var: !173, expr: !DIExpression())
!173 = distinct !DIGlobalVariable(name: "DARWIN", linkageName: "std.core.env.DARWIN", scope: !2, file: !2, line: 147, type: !115, isLocal: false, isDefinition: true, align: 1)
!174 = !DIGlobalVariableExpression(var: !175, expr: !DIExpression())
!175 = distinct !DIGlobalVariable(name: "WIN32", linkageName: "std.core.env.WIN32", scope: !2, file: !2, line: 148, type: !115, isLocal: false, isDefinition: true, align: 1)
!176 = !DIGlobalVariableExpression(var: !177, expr: !DIExpression())
!177 = distinct !DIGlobalVariable(name: "POSIX", linkageName: "std.core.env.POSIX", scope: !2, file: !2, line: 149, type: !115, isLocal: false, isDefinition: true, align: 1)
!178 = !DIGlobalVariableExpression(var: !179, expr: !DIExpression())
!179 = distinct !DIGlobalVariable(name: "OPENBSD", linkageName: "std.core.env.OPENBSD", scope: !2, file: !2, line: 150, type: !115, isLocal: false, isDefinition: true, align: 1)
!180 = !DIGlobalVariableExpression(var: !181, expr: !DIExpression())
!181 = distinct !DIGlobalVariable(name: "FREEBSD", linkageName: "std.core.env.FREEBSD", scope: !2, file: !2, line: 151, type: !115, isLocal: false, isDefinition: true, align: 1)
!182 = !DIGlobalVariableExpression(var: !183, expr: !DIExpression())
!183 = distinct !DIGlobalVariable(name: "NETBSD", linkageName: "std.core.env.NETBSD", scope: !2, file: !2, line: 152, type: !115, isLocal: false, isDefinition: true, align: 1)
!184 = !DIGlobalVariableExpression(var: !185, expr: !DIExpression())
!185 = distinct !DIGlobalVariable(name: "BSD_FAMILY", linkageName: "std.core.env.BSD_FAMILY", scope: !2, file: !2, line: 153, type: !115, isLocal: false, isDefinition: true, align: 1)
!186 = !DIGlobalVariableExpression(var: !187, expr: !DIExpression())
!187 = distinct !DIGlobalVariable(name: "WASI", linkageName: "std.core.env.WASI", scope: !2, file: !2, line: 154, type: !115, isLocal: false, isDefinition: true, align: 1)
!188 = !DIGlobalVariableExpression(var: !189, expr: !DIExpression())
!189 = distinct !DIGlobalVariable(name: "ANDROID", linkageName: "std.core.env.ANDROID", scope: !2, file: !2, line: 155, type: !115, isLocal: false, isDefinition: true, align: 1)
!190 = !DIGlobalVariableExpression(var: !191, expr: !DIExpression())
!191 = distinct !DIGlobalVariable(name: "WASM_NOLIBC", linkageName: "std.core.env.WASM_NOLIBC", scope: !2, file: !2, line: 156, type: !115, isLocal: false, isDefinition: true, align: 1)
!192 = !DIGlobalVariableExpression(var: !193, expr: !DIExpression())
!193 = distinct !DIGlobalVariable(name: "ADDRESS_SANITIZER", linkageName: "std.core.env.ADDRESS_SANITIZER", scope: !2, file: !2, line: 157, type: !115, isLocal: false, isDefinition: true, align: 1)
!194 = !DIGlobalVariableExpression(var: !195, expr: !DIExpression())
!195 = distinct !DIGlobalVariable(name: "MEMORY_SANITIZER", linkageName: "std.core.env.MEMORY_SANITIZER", scope: !2, file: !2, line: 158, type: !115, isLocal: false, isDefinition: true, align: 1)
!196 = !DIGlobalVariableExpression(var: !197, expr: !DIExpression())
!197 = distinct !DIGlobalVariable(name: "THREAD_SANITIZER", linkageName: "std.core.env.THREAD_SANITIZER", scope: !2, file: !2, line: 159, type: !115, isLocal: false, isDefinition: true, align: 1)
!198 = !DIGlobalVariableExpression(var: !199, expr: !DIExpression())
!199 = distinct !DIGlobalVariable(name: "ANY_SANITIZER", linkageName: "std.core.env.ANY_SANITIZER", scope: !2, file: !2, line: 160, type: !115, isLocal: false, isDefinition: true, align: 1)
!200 = !DIGlobalVariableExpression(var: !201, expr: !DIExpression())
!201 = distinct !DIGlobalVariable(name: "LANGUAGE_DEV_VERSION", linkageName: "std.core.env.LANGUAGE_DEV_VERSION", scope: !2, file: !2, line: 161, type: !17, isLocal: false, isDefinition: true, align: 4)
!202 = !DIGlobalVariableExpression(var: !203, expr: !DIExpression())
!203 = distinct !DIGlobalVariable(name: "BUILTIN_EXPECT_IS_DISABLED", linkageName: "std.core.env.BUILTIN_EXPECT_IS_DISABLED", scope: !2, file: !2, line: 201, type: !115, isLocal: false, isDefinition: true, align: 1)
!204 = !DIGlobalVariableExpression(var: !205, expr: !DIExpression())
!205 = distinct !DIGlobalVariable(name: "BUILTIN_PREFETCH_IS_DISABLED", linkageName: "std.core.env.BUILTIN_PREFETCH_IS_DISABLED", scope: !2, file: !2, line: 202, type: !115, isLocal: false, isDefinition: true, align: 1)
!206 = !{i32 2, !"Dwarf Version", i32 4}
!207 = !{i32 2, !"Debug Info Version", i32 3}
!208 = !{i32 2, !"wchar_size", i32 4}
!209 = !{i32 4, !"PIE Level", i32 2}
!210 = !{i32 4, !"PIC Level", i32 2}
!211 = !{i32 1, !"uwtable", i32 2}
!212 = !{i32 2, !"frame-pointer", i32 2}
!213 = distinct !DICompileUnit(language: DW_LANG_C11, file: !2, producer: "c3c", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !214, globals: !215, splitDebugInlining: false)
!214 = !{!16, !58, !124, !154}
!215 = !{!0, !12, !14, !56, !111, !113, !116, !118, !120, !122, !130, !132, !134, !136, !138, !140, !142, !144, !146, !148, !150, !152, !160, !162, !164, !166, !168, !170, !172, !174, !176, !178, !180, !182, !184, !186, !188, !190, !192, !194, !196, !198, !200, !202, !204}
