...
@"$ct.std_math_complex$double$.$anon" = linkonce global %.introspect { i8 9, i64 0, ptr null, i64 16, i64 0, i64 2, [0 x i64] zeroinitializer }, comdat, align 8
@"$ct.std_math_complex$double$.Complex" = linkonce global %.introspect { i8 10, i64 0, ptr null, i64 16, i64 0, i64 2, [0 x i64] zeroinitializer }, comdat, align 8
...
@"std_math_complex$double$.IMAGINARY" = weak local_unnamed_addr constant { %.anon } { %.anon { double 0.000000e+00, double 1.000000e+00 } }, comdat, align 16, !dbg !16
...
@"$ct.dyn.std_math_complex$double$.Complex.to_format" = weak global { ptr, ptr, ptr } { ptr @"std_math_complex$double$.Complex.to_format", ptr @"$sel.to_format", ptr inttoptr (i64 -1 to ptr) }, comdat, align 8
@"$sel.to_format" = linkonce_odr constant [10 x i8] c"to_format\00", comdat, align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @.c3_dynamic_register, ptr null }]

; Function Attrs: nounwind ssp uwtable
define weak i64 @"std_math_complex$double$.Complex.to_format"(ptr %0, ptr %1, ptr %2) #0 comdat !dbg !27 {
entry:
...
checkok:                                          ; preds = %entry
  ...
  %7 = insertvalue %any %6, i64 ptrtoint (ptr @"$ct.double" to i64), 1, !dbg !62
  store %any %7, ptr %varargslots, align 16, !dbg !62
  %8 = load ptr, ptr %self, align 8, !dbg !63
  %ptradd = getelementptr inbounds i8, ptr %8, i64 8, !dbg !63
  %9 = insertvalue %any undef, ptr %ptradd, 0, !dbg !63
  %10 = insertvalue %any %9, i64 ptrtoint (ptr @"$ct.double" to i64), 1, !dbg !63
...
entry:
  %next_val = load ptr, ptr getelementptr inbounds nuw ({ ptr, ptr, ptr }, ptr @"$ct.dyn.std_math_complex$double$.Complex.to_format", i32 0, i32 2), align 8
  %0 = icmp eq ptr %next_val, inttoptr (i64 -1 to ptr)
  br i1 %0, label %dtable_check, label %dtable_skip

dtable_check:                                     ; preds = %dtable_check, %entry
  %dtable_ref = phi ptr [ getelementptr inbounds nuw (%.introspect, ptr @"$ct.std_math_complex$double$.Complex", i32 0, i32 2), %entry ], [ %next_dtable_ref, %dtable_check ]
...
dtable_found:                                     ; preds = %dtable_check
  ...
  store ptr null, ptr getelementptr inbounds nuw ({ ptr, ptr, ptr }, ptr @"$ct.dyn.std_math_complex$double$.Complex.to_format", i32 0, i32 2), align 8
...
!26 = !{!0, !16}
!27 = distinct !DISubprogram(name: "to_format", linkageName: "std_math_complex$double$.Complex.to_format", scope: !2, file: !2, line: 63, type: !28, scopeLine: 63, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !25, retainedNodes: !56)
