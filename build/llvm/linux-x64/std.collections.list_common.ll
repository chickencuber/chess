; ModuleID = 'std::collections::list_common'
source_filename = "std::collections::list_common"
...
!8 = !DIFile(filename: "list_common.c3", directory: "/usr/lib/c3c/lib/std/collections")
